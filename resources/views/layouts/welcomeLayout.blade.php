...
<head>
	...
	<link rel="stylesheet" href="project/template/css/bootstrap.css">
	...
	<link rel="stylesheet" href="project/template/css/color.css">
	<!-- include theme responsive setting stylesheet -->
	<link rel="stylesheet" href="project/template/css/responsive.css">
</head>
<body class="antialiased">
		...
		<header id="header" class="pt-lg-5 pt-md-3 pt-2 position-absolute w-100">
			<div class="container-fluid px-xl-17 px-lg-5 px-md-3 px-0 d-flex flex-wrap">
				<div class="col-6 col-sm-3 col-lg-2 order-sm-2 order-md-0 dis-none">
					<!-- langList -->
					<ul class="nav nav-tabs langList pt-xl-6 pt-lg-4 pt-3 border-bottom-0 nav nav-tabs wishList pt-xl-5 pt-lg-4 pt-3 mr-xl-3 mr-0 justify-content-end border-bottom-0">
				...
				<div class="col-12 col-sm-6 col-lg-8 static-block">
					...
					<div class="mainHolder justify-content-center">
						...
						<nav class="navbar navbar-expand-lg navbar-light p-0 pageNav1 position-static">
							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav mx-auto text-uppercase d-inline-block">
									...
									<li class="nav-item">
										<a class="nLogo" href="home.html"><img src="project/template/images/logo.png" alt="Botanical" class="img-fluid"></a>
									</li>
									<li class="nav-item dropdown">
						...
						<div class="logo">
							<a href="#"><img src="project/template/images/logo.png" alt="Botanical" class="img-fluid"></a>
						</div>
					</div>
				</div>
				<div class="col-6 col-sm-3 col-lg-2 order-sm-3 order-md-0 dis-none">
					...
					<ul class="nav nav-tabs wishList pt-xl-5 pt-lg-4 pt-3 mr-xl-3 mr-0 justify-content-end border-bottom-0">
						...
						<li class="nav-item">    <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Signin</a></li>
                        <li class="nav-item"> <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">login</a>
</li>
	...
	<script src="project/template/js/jquery-3.4.1.min.js"></script>
	<!-- include bootstrap popper JavaScript -->
	<script src="project/template/js/popper.min.js"></script>
