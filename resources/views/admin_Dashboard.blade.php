      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="index.html"><img src="project/dashboard/images/logo.svg" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="project/dashboard/images/logo-mini.svg" alt="logo"/></a>
          </div>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                <img src="project/dashboard/images/faces/face5.jpg" alt="profile" style="width:40px ; border-radius: 50% ;"/>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="project/dashboard/images/faces/face1.jpg" alt="image"/>
                          </td>
                          <td>
                            Herman Beck
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="project/dashboard/images/faces/face2.jpg" alt="image"/>
                          </td>
                          <td>
                            Messsy Adam
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="project/dashboard/images/faces/face3.jpg" alt="image"/>
                          </td>
                          <td>
                            John Richards
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="project/dashboard/images/faces/face4.jpg" alt="image"/>
                          </td>
                          <td>
                            Peter Meggik
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="project/dashboard/images/faces/face5.jpg" alt="image"/>
                          </td>
                          <td>
                            Edward
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="project/dashboard/images/faces/face6.jpg" alt="image"/>
                          </td>
                          <td>
                            John Doe
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="project/dashboard/images/faces/face7.jpg" alt="image"/>
                          </td>
                          <td>
                            Henry Tom
                          </td>
